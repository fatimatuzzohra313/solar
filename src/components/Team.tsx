...
function Teamabout() {
  return (
    <div>
            <section className="dark:bg-dark pb-10 pt-20 lg:pb-20 lg:pt-[120px] mx-8">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto mb-[60px] max-w-[510px] text-center">
                ...
                <h2 className="text-orange-300 mb-3 text-3xl font-bold leading-[1.2]  sm:text-4xl md:text-[40px]">
                  Our Awesome Team
                </h2>
                ...
                <div className="relative overflow-hidden rounded-lg">
                  ...
                  <div className="absolute bottom-5 left-0 w-full text-center">
                    <div className="dark:bg-dark-2 relative mx-5 overflow-hidden rounded-lg bg-white px-3 py-5">
                      <h3 className="text-dark text-base font-semibold dark:text-white">
                        Coriss Ambady
                      </h3>
