        ...
        <div className="py-20 lg:py-24">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <div className="mb-8 inline-flex items-center space-x-2 rounded-full bg-primary px-4 py-2">
              <div className="h-2 w-2 rounded-full bg-[#161e3c] animate-pulse" />
            ...
            <div className="mt-8">
        <button className="px-12 py-4 bg-[#161e3c] hover:bg-primary text-white text-lg font-medium rounded-full  transition duration-300">
          Free Sign Up
        </button>
      </div>          </div>
        </div>
