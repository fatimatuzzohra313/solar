import TradifierHero from "@/components/aboutHeader";
import LandingLayout from "@/components/Layouts/LandingLayout";
import TradifierPromise from "@/components/Promise";
                ...
                <div className="flex w-full flex-col items-start justify-center gap-8">
                  <div className="flex flex-col items-center justify-start gap-4 lg:items-start">
                    ...
                    <div className="flex w-full flex-col items-center justify-start gap-2 lg:items-start">
                      <h2 className="font-manrope text-center text-5xl font-medium leading-normal text-[#161e3c] lg:text-start">
                        Who We Are{" "}
                      </h2>
